# oss-readiness Specification

## Purpose

Define the requirements for preparing the project for open source release. This spec covers documentation
(README, CONTRIBUTING, CODE_OF_CONDUCT), licensing (Apache 2.0), and code quality tooling (pre-commit
hooks, linters for Terraform, Markdown, and YAML).
